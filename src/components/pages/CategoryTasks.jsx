...
const CategoryTasks = () => {
  ...
  const { searchQuery, setSearchQuery } = useTaskFilters(tasks);
      ...
      <div className="flex flex-col h-screen bg-surface">
        <div className="flex items-center justify-center h-64">
          <div className="text-center">
            <ApperIcon name="AlertCircle" className="w-16 h-16 text-neutral-400 mx-auto mb-4" />
          ...
          >
            <div className="bg-white rounded-lg p-6 shadow-sm border border-neutral-200">
              <div className="flex items-center gap-3 mb-4">
                <div className={`w-10 h-10 bg-gradient-to-br from-${category.color}-500 to-${category.color}-600 rounded-lg flex items-center justify-center`}>
